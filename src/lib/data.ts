...
export const toolData: Record<string, ToolData> = {
  ...
  'claude-opus-45': {
    ...
    type: 'AI Model',
    category: 'Premium AI',
    description: 'The new performance leader with the highest SWE-bench score at 74.4%.',
    pricing: '$5/$25 per 1M tokens',
    benchmark: '74.4% SWE-bench',
    features: {
      'Real-time code completion': true,
      'Multi-file editing': true,
      'Design-to-code conversion': true,
  ...
  'claude-opus-46': {
    ...
    type: 'AI Model',
    category: 'Premium AI',
    description: 'The technical leader with 1M context window (beta), Agent Teams, and adaptive thinking capabilities.',
