...
export const toolData: Record<string, ToolData> = {
  ...
  'claude-sonnet-46': {
    ...
    type: 'AI Model',
    category: 'General Purpose AI',
    description: 'The accessible powerhouse - now the default free model on claude.ai. 1M context window (beta), adaptive thinking, and leading OSWorld benchmarks for computer use.',
    pricing: '$3/$15 per 1M tokens',
    benchmark: 'Incoming',
    features: {
      'Real-time code completion': true,
  ...
  'kimi-k25': {
    ...
    type: 'AI Model',
    category: 'Agentic AI',
    description: 'The open-source revolution with full video processing, native multimodal capabilities, and Agent Swarm feature enabling up to 100 sub-agents.',
  ...
  'gemini-31-pro': {
    ...
    type: 'AI Model',
    category: 'Multimodal AI',
    description: 'The efficiency champion with 77.1% ARC-AGI-2 score - more than doubling Gemini 3 Pro reasoning performance. Tiered thinking levels (Low/Medium/High) for cost optimization.',
    pricing: '$2-4/$12-18 per 1M tokens',
    benchmark: 'Incoming',
    features: {
      'Real-time code completion': true,
      ...
      'Max Context Output': '64K',
      'Batch processing discount': true,
      'Prompt caching discount': '✅ (up to 75%)'
    }
  },
  ...
  'claude-opus-46': {
    ...
    type: 'AI Model',
    category: 'Premium AI',
    description: 'The technical leader with 1M context window (beta), Agent Teams, and adaptive thinking capabilities. Preferred over Opus 4.5 in Claude Code 59% of the time.',
  ...
  'glm-5': {
    ...
    type: 'AI Model',
    category: 'Open Source AI',
    description: 'The open-source leader with MIT license, self-hostable on vLLM/SGLang/Huawei Ascend. 744B MoE architecture (40B active per token). Native document generation via Agent Mode.',
  ...
  'antigravity': {
    ...
    type: 'Development Tool',
    category: 'AI-Native IDE',
    description: 'The free disruptor with multi-agent orchestration and integrated Chrome browser automation. Supports Gemini 3.1 Pro, Gemini 3 Flash, Claude Sonnet 4.5/Opus 4.5, and GPT-OSS.',
